var item = document.getElementsByClassName('delete-item')
...
function deleteUserOrder(order_id){
    ...
    var url = '/deleteitem/' /* this is the url of views.updateItem which called  updateItem function in views.py */
