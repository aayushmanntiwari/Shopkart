    ...
    if request.user.is_authenticated:
        ...
        if user.groups.filter(name='user'):
            try:
                ...
                return render(request,'index.html',{'showhome':True,'parent':parent,'childrenn':childrenn,'subchildrenn':subchildrenn,'shownavbar':True,'subsubchildrenn':subsubchildrenn})
        else:
        ...
        total_products_in_cart = 0
        show_shopcart = False
        return render(request,'index.html',{'showhome':True,'parent':parent,'childrenn':childrenn,'subchildrenn':subchildrenn,'shownavbar':True,'total_products_in_cart':total_products_in_cart,'total_amount':total_amount,'show_shopcart':show_shopcart,'subsubchildrenn':subsubchildrenn})